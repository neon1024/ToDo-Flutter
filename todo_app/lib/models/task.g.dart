...
void _taskSerialize(
  ...
  writer.writeInt(offsets[2], object.status.index);
...
Task _taskDeserialize(
  ...
  final object = Task(
    ...
    status: _TaskstatusValueEnumMap[reader.readIntOrNull(offsets[2])] ??
        Status.toDo,
    title: reader.readStringOrNull(offsets[3]) ?? "Task",
  );
  object.id = id;
  return object;
}
...
P _taskDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_TaskstatusValueEnumMap[reader.readIntOrNull(offset)] ??
          Status.toDo) as P;
    case 3:
      return (reader.readStringOrNull(offset) ?? "Task") as P;
    default:
